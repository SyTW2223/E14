      ...
      <div className="zona-personajes-home">
        {characters.map((character) => {
          ...
          if (character.thumbnail.path === 'http://i.annihil.us/u/prod/marvel/i/mg/b/40/image_not_available') 
            portada_personaje = "https://media4.giphy.com/media/j6aoUHK5YiJEc/giphy.gif?cid=ecf05e47eev3bvox4etxd6olnes3t021q8m41i03rajj114e&rid=giphy.gif&ct=g";
          else portada_personaje = `${character.thumbnail.path}.${character.thumbnail.extension}`
          return (
            <div className='personaje-home'>
              <img src={portada_personaje} alt={character.name} className='personaje-home__img'/>
